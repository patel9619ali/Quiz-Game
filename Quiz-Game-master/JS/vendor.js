...
function getAnswer(){
    ...
    if(scoreCard > 2){
        let sadTag = document.createElement("p");
        var sadEmoji = document.createTextNode("&#128512;");
        sadTag.appendChild(sadEmoji);
        sadTag.classList.add("text-center");
        selectScoreCard.appendChild(sadTag);
    }
    else{
        let happyTag = document.createElement("p");
        var happyEmoji = document.createTextNode("&#128532;");
        happyTag.appendChild(happyEmoji);
        happyTag.classList.add("text-center");
        selectScoreCard.appendChild(happyTag);
    }
